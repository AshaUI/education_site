...
car.color='white'
print(c1.color)   #it takes color from already created(previous) object,so already created one having 'red' only
print(car.color)  # color in class is changed

car.color='blue'  # static var  value changed created new object 
c2=car()     # color var in class is changed from white to blue  and re created object so both color vars will give o/p as blue
print(c2.color)
print(car.color)
